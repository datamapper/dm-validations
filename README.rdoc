...
See data_mapper/validations/macros.rb for to learn about the complete collection of validation rules available.
...
If your validators find errors in your model, they will populate the DataMapper::Validations::ErrorSet object that is available through each of your models via calls to your model's errors method.
...
See DataMapper::Validations::ErrorSet for all you can do with your model's
errors method.
