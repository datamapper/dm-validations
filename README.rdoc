...
If your validators find errors in your model, they will populate the DataMapper::Validation::ErrorSet object that is available through each of your models via calls to your model's errors method.
...
See DataMapper::Validation::ErrorSet for all you can do with your model's
errors method.
