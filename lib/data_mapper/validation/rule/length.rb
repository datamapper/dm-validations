...
require 'data_mapper/validation/rule/length/equal'
require 'data_mapper/validation/rule/length/range'
require 'data_mapper/validation/rule/length/minimum'
require 'data_mapper/validation/rule/length/maximum'
